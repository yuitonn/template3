                ...
                <div>
                    ...
                    @foreach ( $quizzes as $quiz)
                        <div class="text-center mt-8">
                            ...
                            <a href="{{ route('quizzes.edit', ['id' => $quiz->id]) }}" class="text-blue-500 pl-4">編集</a>
                            <a href="{{ route('admin.quizzes.questions.index', ['quiz' => $quiz->id]) }}" class="text-blue-500 pl-4">設問一覧</a>
                            <button class="text-red-500 pl-4" onclick="confirmDelete({{ $quiz->id }})">削除</button>
                        </div>
                    @endforeach
